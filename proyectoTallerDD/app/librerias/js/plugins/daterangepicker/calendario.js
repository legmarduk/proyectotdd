...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        //original: this.format = 'MM/DD/YYYY';
        ...
        this.locale = {
            applyLabel: 'Apply',
            cancelLabel: 'Cancel',
            //fromLabel: 'From', //eliminado por cesar
            //toLabel: 'To', //eliminado por cesar
            weekLabel: 'W',
        ...
        //Esta seccion a sido modificada por cesar
        /*
        lo que fue eliminado de la linea en blanco
        ...
        if (!hasOptions || (typeof options.startDate == 'undefined' && typeof options.endDate == 'undefined')) {
            if ($(this.element).is('input[type=text]')) {
                ...
                if (split.length == 2) {
                    ...
                    //end = moment(split[1], this.format); comentado por cesar
                }
                if (start != null) { //  && end != null
                    this.startDate = start;
                    //this.endDate = end; comentado por cesar
                }
            }
        }
    ...
    DateRangePicker.prototype = {
        ...
        enterRange: function (e) {
            ...
            if (label == this.locale.customRangeLabel) {
                ...
                //this.container.find('input[name=daterangepicker_end]').val(dates[1].format(this.format)); comentado por cesar
            }
        },
        ...
        updateInputText: function () {
            ...
            //original: this.element.val(this.startDate.format(this.format) + this.separator + this.endDate.format(this.format));
        },
